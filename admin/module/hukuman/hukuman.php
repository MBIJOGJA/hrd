...
$sql = "SELECT * FROM hukuman a, pegawai b where a.nip=b.nip order by a.tgl_hukuman desc ";
...
<?php 
// Tampilkan data dari Database
$sql = "select * from pegawai z, sk_krj s, unit_krj u, jabatan j where s.id_jabatan=j.id_jabatan and s.id_unit_krj=u.id_unit_krj and z.nip=s.nip and s.status_sk='aktif'";
$tampil = mysql_query($sql);
$no=1;
...
<?php
  ...
  $nextID = "HKM/LR/".date('m/y')."/".sprintf("%04s",$nextNoUrut);
?>
