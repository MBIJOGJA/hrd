...
if($query)
{ 
echo " <script>alert('Update Data Prestasi Berhasil');</script> ";
echo " <script>window.location='../../index.php?module=prestasi'; </script>";
}
	else{
		echo " <script>alert('Update Data Prestasi Berhasil');</script> ";
		echo " <script>window.location='../../index.php?module=prestasi'; </script>";
...
if($simpan)
{ 
echo " <script>alert('Input Data Prestasi Berhasil');</script> ";
echo " <script>window.location='../../index.php?module=prestasi'; </script>";
}
	else{
		echo " <script>alert('Input Data Prestasi Berhasil');</script> ";
