...
<h3 class="box-title margin text-center">Data Master STR (Surat Tanda Regristrasi)</h3>
<br/>
<div class="row">
<div class="col-md-6">
  ...
  <div class="form-group">
    <label class="col-sm-4 control-label">Nomor STR</label>
    <div class="col-sm-7">
...
<div class="form-group">
    <label class="col-sm-4 control-label">Tanggal STR</label>
        <div class="col-sm-7">
  <div class="col-sm-7">
    </div>
...
<?php 
// Tampilkan data dari Database
$sql = "SELECT * from sk_krj sk JOIN jabatan j ON sk.id_jabatan=j.id_jabatan JOIN unit_krj u ON sk.id_unit_krj=u.id_unit_krj JOIN status_pegawai st ON sk.id_status_pegawai=st.id_status_pegawai JOIN pegawai  p ON p.nip=sk.nip WHERE sk.status_sk='aktif' and sk.jenis_sk='STR' order by sk.tgl_sk DESC";
$tampil = mysql_query($sql);
$no=1;
while ($tampilkan = mysql_fetch_array($tampil)) { 
...
?>
  ...
  <td><?php echo $tampilkan['nip'];?></td> 
	...
	<td align="center">
	<a class="btn btn-xs btn-info" href="?module=str&aksi=edit&no_sk=<?php echo $tampilkan['no_sk'];?>" alt="Edit Data"><i class="glyphicon glyphicon-pencil"></i></a>
	<a class="btn btn-xs btn-danger" href="<?php echo $aksi ?>?module=str&aksi=hapus&no_sk=<?php echo $tampilkan['no_sk'];?>"  alt="Delete Data" onclick="return confirm('ANDA YAKIN AKAN MENGHAPUS DATA <?php echo $id_jadwal; ?>	?')"> <i class="glyphicon glyphicon-trash"></i></a>
	</td>
	<?php
	}
	?>
...
<h3 class="box-title margin text-center">Edit Data STR NO. <font color="red"> "<?php echo $_GET['no_sk']; ?>"</font></h3>
<br/>
<form class="form-horizontal" action="<?php echo $aksi?>?module=str&aksi=edit" role="form" method="post">             
