...
<html>
  ...
  <body class="skin-blue sidebar-mini fixed">
    ...
    <li><a href='?module=sip' ><i class="fa fa-institution"></i><span>SIP</span></a></li>
      ...
      <li class="treeview">
       <a href="#">
                <i class="fa fa-tasks"></i> <span>Presensi</span> <i class="fa fa-angle-left pull-right"></i>
              </a>
      <ul class="treeview-menu">
      ...
      <li class="treeview">
       <a href="#">
       <i class="fa fa-tasks"></i> <span>SK Kerja</span> <i class="fa fa-angle-left pull-right"></i>
              </a>
      <ul class="treeview-menu">
	...
	<?php include "isi.php";?>        		
       ...
       <footer class="main-footer">
        <div class="pull-right hidden-xs">
          SUREMING - RS. Lestari Raharja <b>Version</b> 1.0
        </div>
        <strong>Copyright &copy; 2018 <a href="#">RS. Lestari Raharja</a>.</strong> 
