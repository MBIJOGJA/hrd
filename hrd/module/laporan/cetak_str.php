...
?>
          <section class="content-header">
            <h1>
             Laporan
              <small>STR Kerja Pegawai</small>
            </h1>
            <ol class="breadcrumb">
              <li><a href="#"><i class="fa fa-dashboard"></i> Laporan</a></li>
              <li class="active">STR Kerja</li>
            </ol>
          </section>
...
<!-- 			<b>Rumah Sakit Lestari raharja <br/>
            ...
            <div class="box box-default">
              <div class="box-header with-border">
                <h3 class="box-title center">Daftar STR Kerja Pegawai</h3>
...
$sql = "SELECT * FROM sk_krj sk JOIN pegawai p ON sk.nip=p.nip JOIN jabatan j ON j.id_jabatan=sk.id_jabatan JOIN unit_krj u ON u.id_unit_krj=sk.id_unit_krj WHERE sk.status_sk='aktif' and sk.jenis_sk='STR' and sk.tgl_selesai between '".$d."' and '".$h."'";
...
?>
	...
	<td><?php echo IndonesiaTgl($k['tgl_selesai']); ?></td>
