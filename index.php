...
<html>
  ...
  <body background="bg-login.jpg" style="background-position: center; background-size: cover;">
    <div class="login-box gradient">
      <div class="login-logo">
        <br>
        <a><b><font color="white">HR</font><font  color="red">MS</font>
          <br/><h4><font color="black">Human Resource Management System</font></h4></a></b>
      </div><!-- /.login-logo -->
