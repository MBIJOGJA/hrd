      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
         <li style="margin:2%;">
			<table>
			<tr>
			<td rowspan="3"><img src="../aset/dist/img/user.png "style="margin-right:15px;width:45px;height:45px;" class="img-circle" alt="User Image" /></td>
			<th><h4 class="text-red">Selamat Datang</h4>
			</th>
			</tr>
			</table>
			</li>
