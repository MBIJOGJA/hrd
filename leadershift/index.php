    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="" class="logo">
          ...
          <span class="logo-lg"><b>SUREMING</b></span>
        </a>
      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
         <li style="margin:2%;">
			...
			<th><h4 class="text-green">(( Leadershift ))</h4>
			</th>
      ...
      <li class="treeview">
       <a href="#">
                <i class="fa fa-tasks"></i> <span>Absensi</span> <i class="fa fa-angle-left pull-right"></i>
              </a>
      ...
      <li class="treeview">
       <a href="#">
                <i class="fa fa-tasks"></i> <span>Cuti</span> <i class="fa fa-angle-left pull-right"></i>
              </a>
      <ul class="treeview-menu">
      ...
      <div style="background:url(../images/0.png)repeat;" class="content-wrapper">
        ...
        <section  class="content-header">
          <h1> SUREMING
            <small>( Smart Human Resource Management Processing )</small>
          </h1>
          <ol class="breadcrumb">
	...
	<?php include "isi.php";?>        		
      ...
      <footer class="main-footer">
        <div class="pull-right hidden-xs">
         SUREMING - Rumah Sakit Lestari Raharja <b>Version</b> 1.0
        </div>
        <strong>Copyright &copy; 2018 <a href="#">RS Lestari raharja </a>.</strong> All rights reserved.
